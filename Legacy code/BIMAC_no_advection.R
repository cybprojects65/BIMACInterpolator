...
posterior_data_output = "./output/BIMAC_interpolation_no_advection.asc"
posterior_data_output_sd = "./output/BIMAC_interpolation_sd_no_advection.asc"

automatic_extent<-T
fast_solving<-T
resolution<-1
moving_average_points<-2
smooth = T
